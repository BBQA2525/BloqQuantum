...
directory_path = "./data/QRC_CQIM_RidgeRegression_" + str(qpu_topology['type']) + "_" + date_string
...
now = datetime.datetime.now()
date_string = now.strftime("%Y-%m-%d_%H-%M-%S")
directory_path_test = "./data/QRC_CQIM_RidgeRegression_test_" + str(qpu_topology['type']) + "_" + date_string
